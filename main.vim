...
noremap <silent><expr>Q index(['quickfix', 'nofile', 'terminal'], &buftype) < 0 ? ":bd<CR>" : ":q<CR>"
noremap <silent><expr><leader>q index(['quickfix', 'nofile', 'terminal'], &buftype) < 0 ? ":bd<CR>" : ":q<CR>"
noremap <silent><expr><leader><S-Q>  index(['quickfix', 'nofile', 'terminal'], &buftype) < 0 ? ":bd!<CR>" : ":q<CR>"
